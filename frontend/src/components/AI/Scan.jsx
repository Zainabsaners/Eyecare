...
const Scan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('/scans/', formData, {
        headers: {
      ...
      setError('Scan failed. Please try again. Make sure you are logged in.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="container" style={{ padding: '2rem' }}>
      <div style={{
          ...
          <div style={{
            ...
            <label htmlFor="eye-image" style={{ cursor: 'pointer' }}>
              {previewUrl ? (
                ...
                <div>
                  <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>Ì≥∑</div>
        ...
        <div style={{ marginTop: '2rem', padding: '1rem', background: '#f8f9fa', borderRadius: '8px' }}>
          <h4 style={{ marginBottom: '1rem' }}>Ì≥ù Tips for best results:</h4>
